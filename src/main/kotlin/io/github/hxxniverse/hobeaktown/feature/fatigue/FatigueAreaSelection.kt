...
fun FatigueAreaSelection.toItemStack(): ItemStack {
    return ItemStackBuilder()
            ...
            .setDisplayName(text(name, NamedTextColor.GOLD).append(text(" 구역 지정 막대", NamedTextColor.WHITE)))
            .addLore(text("이 아이템을 [Left]/[Shift + Left]하여 피로도 영역을 선택합니다.", NamedTextColor.GRAY))
            .addLore(text(""))
